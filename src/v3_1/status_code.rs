...
#[cfg(feature = "conversions")]
impl From<v3_0::StatusCode> for StatusCode {
    fn from(c: v3_0::StatusCode) -> Self {
        match c {
            v3_0::StatusCode::Code(code) => StatusCode::Code(code),
            v3_0::StatusCode::Range(range) => StatusCode::Range(range),
        }
    }
}
